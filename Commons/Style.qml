...
Singleton {
  ...
  readonly property real effectivePanelOpacity: PowerProfileService.hydraPerformanceMode ? 1.0 : Color.adaptiveOpacity(Settings.data.ui.panelBackgroundOpacity)
  readonly property real effectiveBarOpacity: PowerProfileService.hydraPerformanceMode ? 1.0 : Settings.data.bar.backgroundOpacity
  ...
  readonly property int animationFaster: (Settings.data.general.animationDisabled || PowerProfileService.hydraPerformanceMode) ? 0 : Math.round(75 / Settings.data.general.animationSpeed)
