...
Singleton {
  ...
  Connections {
    ...
    function onHydraPerformanceModeChanged() {
      const isEnabled = PowerProfileService.hydraPerformanceMode;
  ...
  function init() {
    ...
    Qt.callLater(() => {
                   ...
                   wasPerformanceModeEnabled = PowerProfileService.hydraPerformanceMode;
                   // Execute startup hook
                   executeStartupHook();
                 });
  }
