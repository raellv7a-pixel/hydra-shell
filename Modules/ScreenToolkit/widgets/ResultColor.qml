    ...
    Column {
      ...
      Row {
        ...
        Rectangle {
          ...
          Image {
            id: pixelImg
            anchors.fill: parent
            source: root.colorCapturePath !== "" ? ("file://" + root.colorCapturePath + "?b=" + root.colorCacheBust) : ""
          ...
          Rectangle {
            ...
            MouseArea {
              ...
              onClicked: {
                ...
                ToastService.showNotice(pluginApi?.tr("panel.formatCopied", {
                                                        label: pluginApi?.tr("panel.labelHex")
                                                      }));
              }
            }
            NStateLayer {
      ...
      Repeater {
        model: [
          {
            label: pluginApi?.tr("panel.labelHex"),
            value: root.pickedHex
          },
          {
            label: pluginApi?.tr("panel.labelRgb"),
            value: root.pickedRgb
          },
          {
            label: pluginApi?.tr("panel.labelHsl"),
            value: root.pickedHsl
          },
          {
            label: pluginApi?.tr("panel.labelHsv"),
            value: root.pickedHsv
          }
        ]
        delegate: Rectangle {
          width: root.width
