...
Loader {
  ...
  sourceComponent: Variants {
    ...
    delegate: PanelWindow {
      ...
      WlrLayershell.namespace: "hydra-overview-" + (screen?.name || "unknown")
      ...
      Image {
        ...
        layer.enabled: Settings.data.wallpaper.overviewBlur > 0 && !PowerProfileService.hydraPerformanceMode
        layer.smooth: false
