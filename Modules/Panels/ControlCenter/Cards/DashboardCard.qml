...
// Shared base for every dashboard card/tile: background/border driven by the
// panel's per-component style overrides, plus the detail-view enter
// transition (slide + fade + scale) used by every *DetailsCard.
