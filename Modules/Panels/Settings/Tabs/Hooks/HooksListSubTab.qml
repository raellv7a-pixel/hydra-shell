...
ColumnLayout {
  ...
  // Startup Hook
  HookRow {
    label: I18n.tr("panels.hooks.hydra-started-label")
    description: I18n.tr("panels.hooks.hydra-started-description")
    value: Settings.data.hooks.startup
    onEditClicked: openEdit(label, description, I18n.tr("panels.hooks.hydra-started-placeholder"), value, newValue => {
