...
ColumnLayout {
  ...
  property bool valueShowHydraPerformance: widgetData.showHydraPerformance !== undefined ? widgetData.showHydraPerformance : widgetMetadata.showHydraPerformance
  ...
  function saveSettings() {
    ...
    settings.showHydraPerformance = valueShowHydraPerformance;
  ...
  NToggle {
    label: I18n.tr("bar.battery.show-hydra-performance-label")
    description: I18n.tr("bar.battery.show-hydra-performance-description")
    checked: valueShowHydraPerformance
    onToggled: checked => {
                 valueShowHydraPerformance = checked;
                 saveSettings();
               }
    defaultValue: widgetMetadata.showHydraPerformance
  }
}
